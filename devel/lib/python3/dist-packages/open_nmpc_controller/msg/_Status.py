...
"""autogenerated by genpy from open_nmpc_controller/Status.msg. Do not edit."""
import codecs
import sys
...
class Status(genpy.Message):
  _md5sum = "705a4d9975e4aa946bbea90452d3c53e"
  _type = "open_nmpc_controller/Status"
...
"""
  ...
  _slot_types = ['std_msgs/Header','int32','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','int32','float64','bool','bool','bool','bool','bool','bool']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_i11did6B().pack(_x.uptime, _x.ros_control_loop_freq, _x.mcu_and_user_port_current, _x.left_driver_current, _x.right_driver_current, _x.battery_voltage, _x.left_driver_voltage, _x.right_driver_voltage, _x.left_driver_temp, _x.right_driver_temp, _x.left_motor_temp, _x.right_motor_temp, _x.capacity_estimate, _x.charge_estimate, _x.timeout, _x.lockout, _x.e_stop, _x.ros_pause, _x.no_battery, _x.current_limit))
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_i11did6B = None
def _get_struct_i11did6B():
    global _struct_i11did6B
    if _struct_i11did6B is None:
        _struct_i11did6B = struct.Struct("<i11did6B")
    return _struct_i11did6B
